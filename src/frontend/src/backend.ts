...
import type { PostView as _PostView, ReputationReview as _ReputationReview, SocialLinks as _SocialLinks, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async applyToEvent(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.applyToEvent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async approveApplication(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async commentOnPost(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createCommunity(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createCommunity(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createEvent(arg0: string, arg1: string, arg2: string, arg3: Time, arg4: Array<string>, arg5: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async createPost(arg0: string, arg1: string, arg2: string | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createPost(arg0, arg1, to_candid_opt_n14(this._uploadFile, this._downloadFile, arg2));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllCommunities(): Promise<Array<CommunityView>> {
        if (this.processError) {
            try {
    ...
    async getCommunityPosts(arg0: string): Promise<Array<CommunityPost>> {
        if (this.processError) {
            try {
    ...
    async getEventApplications(arg0: string): Promise<Array<Principal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getEventApplications(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getGlobalFeed(): Promise<Array<PostView>> {
        if (this.processError) {
            try {
    ...
    async getPersonalizedFeed(): Promise<Array<PostView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPersonalizedFeed();
                return from_candid_vec_n23(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReputation(arg0: Principal): Promise<Array<ReputationReview>> {
        if (this.processError) {
            try {
    ...
    async getSkills(arg0: Principal): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSkills(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async leaveCommunity(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async rejectApplication(arg0: string, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
    ...
    async searchBySkill(arg0: string): Promise<Array<[UserProfile, Array<string>, Array<ReputationReview>]>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchBySkill(arg0);
    ...
    async submitReputationReview(arg0: Principal, arg1: ReputationScores, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitReputationReview(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PostView_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PostView): PostView {
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        linkedin: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.linkedin)),
        ...
        website: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.website)),
        github: record_opt_to_undefined(from_candid_opt_n20(_uploadFile, _downloadFile, value.github))
    };
}
...
function from_candid_tuple_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [_UserProfile, Array<string>, Array<_ReputationReview>]): [UserProfile, Array<string>, Array<ReputationReview>] {
    return [
...
function from_candid_vec_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_PostView>): Array<PostView> {
    return value.map((x)=>from_candid_PostView_n24(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[_UserProfile, Array<string>, Array<_ReputationReview>]>): Array<[UserProfile, Array<string>, Array<ReputationReview>]> {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bio: value.bio,
        socialLinks: to_candid_SocialLinks_n12(_uploadFile, _downloadFile, value.socialLinks),
        name: value.name,
        designation: value.designation,
        year: value.year,
        avatarUrl: value.avatarUrl,
